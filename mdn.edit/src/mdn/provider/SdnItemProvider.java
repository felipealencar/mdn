...
/**
 * This is the item provider adapter for a {@link mdn.Sdn} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdnItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MdnPackage.Literals.SDN__APPS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MdnPackage.Literals.SDN__NODES,
				 MdnFactory.eINSTANCE.createController()));
		...
		newChildDescriptors.add
			(createChildParameter
				(MdnPackage.Literals.SDN__APPS,
				 MdnFactory.eINSTANCE.createAppMonitor()));
