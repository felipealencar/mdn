...
public class MdnVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case SdnEditPart.VISUAL_ID:
			if (MdnPackage.eINSTANCE.getOpenFlowSwitch().isSuperTypeOf(
					domainElement.eClass())) {
				return OpenFlowSwitchEditPart.VISUAL_ID;
			}
			...
			if (MdnPackage.eINSTANCE.getAppMonitor().isSuperTypeOf(
					domainElement.eClass())) {
			...
			if (MdnPackage.eINSTANCE.getApp().isSuperTypeOf(
					domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		switch (containerVisualID) {
		case SdnEditPart.VISUAL_ID:
			if (OpenFlowSwitchEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case OpenFlowSwitchEditPart.VISUAL_ID:
			if (OpenFlowSwitchNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
