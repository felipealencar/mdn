 ...
 * @generated
 */
public class MdnElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MdnElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.MdnElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "mdn".equals(fileExtension); //$NON-NLS-1$
	}
