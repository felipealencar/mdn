...
import mdn.diagram.part.MdnDiagramEditorUtil;
 ...
 * @generated
 */
public class MdnMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = MdnDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			MdnDiagramEditorUtil.selectElementsInDiagram(editor,
