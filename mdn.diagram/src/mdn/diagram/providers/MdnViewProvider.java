...
import mdn.diagram.edit.parts.WrappingLabel14EditPart;
import mdn.diagram.edit.parts.WrappingLabel15EditPart;
 ...
 * @generated
 */
public class MdnViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SdnEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& MdnVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MdnVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!MdnElementTypes.isKnownElementType(elementType)
				...
				if (!SdnEditPart.MODEL_ID.equals(MdnVisualIDRegistry
		...
		return OpenFlowSwitchEditPart.VISUAL_ID == visualID
				...
				|| AppEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = MdnVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != MdnVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = MdnVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = MdnVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case OpenFlowSwitchEditPart.VISUAL_ID:
			return createOpenFlowSwitch_2022(domainElement, containerView,
					index, persisted, preferencesHint);
		case ControllerEditPart.VISUAL_ID:
			return createController_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case HostEditPart.VISUAL_ID:
			return createHost_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case SwitchEditPart.VISUAL_ID:
			return createSwitch_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case AppMonitorEditPart.VISUAL_ID:
			return createAppMonitor_2019(domainElement, containerView, index,
					persisted, preferencesHint);
		case RuleEditPart.VISUAL_ID:
			return createRule_2021(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConditionEditPart.VISUAL_ID:
		...
		case PacketHeaderEditPart.VISUAL_ID:
			return createPacketHeader_2016(domainElement, containerView, index,
					persisted, preferencesHint);
		case AppEditPart.VISUAL_ID:
			return createApp_2020(domainElement, containerView, index,
					persisted, preferencesHint);
		case GroupEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (MdnVisualIDRegistry.getVisualID(elementTypeHint)) {
		...
		case AppActionPacketHeaderEditPart.VISUAL_ID:
			return createAppActionPacketHeader_4029(containerView, index,
					persisted, preferencesHint);
		case AppAppToNetworkNodeEditPart.VISUAL_ID:
			return createAppAppToNetworkNode_4030(containerView, index,
					persisted, preferencesHint);
		case AppControllerAppEditPart.VISUAL_ID:
			return createAppControllerApp_4031(containerView, index, persisted,
					preferencesHint);
		case AppAppRuleEditPart.VISUAL_ID:
			return createAppAppRule_4032(containerView, index, persisted,
					preferencesHint);
		case AppTargetSwitchEditPart.VISUAL_ID:
			return createAppTargetSwitch_4033(containerView, index, persisted,
					preferencesHint);
	 ...
	 * @generated
	 */
	public Node createOpenFlowSwitch_2022(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry
				.getType(OpenFlowSwitchEditPart.VISUAL_ID));
		...
		Node label5023 = createLabel(node,
				MdnVisualIDRegistry
						.getType(OpenFlowSwitchNameEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createController_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(ControllerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createHost_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(HostEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createSwitch_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(SwitchEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createAppMonitor_2019(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(AppMonitorEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5020 = createLabel(node,
				MdnVisualIDRegistry.getType(AppMonitorNameEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createRule_2021(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	public Node createCondition_2013(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(ConditionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createTraffic_2014(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(TrafficEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createTime_2015(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(TimeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createPacketHeader_2016(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry
				.getType(PacketHeaderEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createApp_2020(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MdnVisualIDRegistry.getType(AppEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5021 = createLabel(node,
				MdnVisualIDRegistry.getType(AppNameEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createHostHostSwitch_4004(View containerView, int index,
		...
		Node label6003 = createLabel(edge,
				MdnVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createAppActionPacketHeader_4029(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MdnVisualIDRegistry
				.getType(AppActionPacketHeaderEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createAppAppToNetworkNode_4030(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MdnVisualIDRegistry
				.getType(AppAppToNetworkNodeEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createAppControllerApp_4031(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MdnVisualIDRegistry
				.getType(AppControllerAppEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createAppAppRule_4032(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MdnVisualIDRegistry.getType(AppAppRuleEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createAppTargetSwitch_4033(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MdnVisualIDRegistry
				.getType(AppTargetSwitchEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	public Edge createConditionConditionTraffic_4018(View containerView,
		...
		Node label6017 = createLabel(edge,
				MdnVisualIDRegistry.getType(WrappingLabel14EditPart.VISUAL_ID));
	...
	public Edge createConditionConditionPacket_4019(View containerView,
		...
		Node label6018 = createLabel(edge,
				MdnVisualIDRegistry.getType(WrappingLabel15EditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SdnEditPart.MODEL_ID.equals(MdnVisualIDRegistry
			...
			shortcutAnnotation.getDetails()
					.put("modelID", SdnEditPart.MODEL_ID); //$NON-NLS-1$
