 ...
 * @generated
 */
public class MdnModelingAssistantProviderOfSwitchEditPart extends
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnSourceAndTarget((SwitchEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			SwitchEditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((SwitchEditPart) sourceEditPart,
				relationshipType);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetTypesForTarget(SwitchEditPart source,
			IElementType relationshipType) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((SwitchEditPart) targetEditPart,
				relationshipType);
	}
	 ...
	 * @generated
	 */
	public List<IElementType> doGetTypesForSource(SwitchEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
