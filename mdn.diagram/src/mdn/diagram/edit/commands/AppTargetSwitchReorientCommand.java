 ...
 * @generated
 */
public class AppTargetSwitchReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AppTargetSwitchReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Switch && newEnd instanceof App)) {
			return false;
		}
		return MdnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAppTargetSwitch_4033(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MdnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAppTargetSwitch_4033(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getTargetSwitch().remove(getOldTarget());
		getNewSource().getTargetSwitch().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getTargetSwitch().remove(getOldTarget());
		getOldSource().getTargetSwitch().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
