 ...
 * @generated
 */
public class SwitchSwitchReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SwitchSwitchReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return MdnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSwitchSwitch_4008(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MdnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSwitchSwitch_4008(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSwitch().remove(getOldTarget());
		getNewSource().getSwitch().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSwitch().remove(getOldTarget());
		getOldSource().getSwitch().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
