...
public class RuleSourceHostRuleReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RuleSourceHostRuleReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return MdnBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistRuleSourceHostRule_4024(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MdnBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistRuleSourceHostRule_4024(getOldSource(), getNewTarget());
	}
