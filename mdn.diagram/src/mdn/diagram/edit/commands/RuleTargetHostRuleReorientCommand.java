...
public class RuleTargetHostRuleReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RuleTargetHostRuleReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return MdnBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistRuleTargetHostRule_4025(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MdnBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistRuleTargetHostRule_4025(getOldSource(), getNewTarget());
	}
