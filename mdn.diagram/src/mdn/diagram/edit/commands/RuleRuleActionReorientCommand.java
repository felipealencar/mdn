 ...
 * @generated
 */
public class RuleRuleActionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RuleRuleActionReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Action && newEnd instanceof Rule)) {
			return false;
		}
		return MdnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRuleRuleAction_4027(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MdnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRuleRuleAction_4027(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setRuleAction(null);
		getNewSource().setRuleAction(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setRuleAction(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
