 ...
 * @generated
 */
public class GroupGroupHostsGroupCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return MdnPackage.eINSTANCE.getGroup_HostsGroup();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return Host2EditPart.VISUAL_ID == MdnVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<MdnNodeDescriptor> childDescriptors = MdnDiagramUpdater
				.getGroupGroupHostsGroupCompartment_7001SemanticChildren((View) getHost()
						.getModel());
