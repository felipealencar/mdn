 ...
 * @generated
 */
public class TimeItemSemanticEditPolicy extends MdnBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MdnVisualIDRegistry.getVisualID(incomingLink) == ConditionConditionTimeEditPart.VISUAL_ID) {
