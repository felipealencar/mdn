 ...
 * @generated
 */
public class AppMonitorNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				MdnVisualIDRegistry
						.getType(mdn.diagram.edit.parts.AppMonitorNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MdnParserProvider
					.getParser(
							MdnElementTypes.AppMonitor_2019,
							getParserElement(),
							MdnVisualIDRegistry
									.getType(mdn.diagram.edit.parts.AppMonitorNameEditPart.VISUAL_ID));
		}
