...
public class WrappingLabel6EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				MdnVisualIDRegistry
						.getType(mdn.diagram.edit.parts.WrappingLabel6EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SdnEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MdnParserProvider.getParser(
					MdnElementTypes.RuleRuleCondition_4026, getParserElement(),
