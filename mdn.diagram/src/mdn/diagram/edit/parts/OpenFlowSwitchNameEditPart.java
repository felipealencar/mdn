...
import mdn.diagram.edit.policies.MdnTextSelectionEditPolicy;
 ...
 * @generated
 */
public class OpenFlowSwitchNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				MdnVisualIDRegistry
						.getType(mdn.diagram.edit.parts.OpenFlowSwitchNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public OpenFlowSwitchNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MdnTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MdnParserProvider
					.getParser(
							MdnElementTypes.OpenFlowSwitch_2022,
							getParserElement(),
							MdnVisualIDRegistry
									.getType(mdn.diagram.edit.parts.OpenFlowSwitchNameEditPart.VISUAL_ID));
		}
	...
	protected IFigure createFigurePrim() {
		return new OpenFlowSwitchLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OpenFlowSwitchLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OpenFlowSwitchLabelFigure() {
			this.setText("OpenFlowSwitch");
		}
