...
import mdn.diagram.edit.policies.RuleRuleConditionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RuleRuleConditionEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RuleRuleConditionItemSemanticEditPolicy());
	}
