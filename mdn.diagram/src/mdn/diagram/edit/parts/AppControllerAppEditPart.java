...
import mdn.diagram.edit.policies.AppControllerAppItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AppControllerAppEditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AppControllerAppItemSemanticEditPolicy());
	}
