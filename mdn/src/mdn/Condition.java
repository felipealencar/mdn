 ...
 * @model annotation="gmf.node label='condition' label.icon='false' tool.small.bundle='mdn.edit' tool.small.path='/icons/full/obj16/condition.gif' label.placement='external' figure='ConditionFigure'"
 * @generated
 */
public interface Condition extends AppObject {
	/**
