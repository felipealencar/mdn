 ...
 * @model annotation="gmf.node figure='TrafficFigure' label='operator,value,unit' label.pattern='{0}: {2}{1}' label.icon='false' tool.small.bundle='mdn.edit' tool.small.path='/icons/full/obj16/traffic.gif' label.placement='external'"
 * @generated
 */
public interface Traffic extends AppObject {
	/**
