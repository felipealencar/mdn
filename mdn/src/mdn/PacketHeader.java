 ...
 * @model annotation="gmf.node label.icon='false' tool.small.bundle='mdn.edit' tool.small.path='/icons/full/obj16/packetheader.gif' label.placement='external' label='operator,header,value' label.pattern='{0}: [{1}] {2}'"
 * @generated
 */
public interface PacketHeader extends AppObject {
	/**
	 ...
	 * The default value is <code>"IPV4_DST"</code>.
