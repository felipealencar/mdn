 ...
 * @model annotation="gmf.node label='name' label.icon='false' tool.small.bundle='mdn.edit' tool.small.path='/icons/full/obj16/host.gif' figure='HostFigure' label.placement='external'"
 * @generated
 */
