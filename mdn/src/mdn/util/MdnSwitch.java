...
public class MdnSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MdnPackage.OPEN_FLOW_SWITCH: {
				OpenFlowSwitch openFlowSwitch = (OpenFlowSwitch)theEObject;
				T result = caseOpenFlowSwitch(openFlowSwitch);
				if (result == null) result = caseSwitch(openFlowSwitch);
				if (result == null) result = caseNetworkNode(openFlowSwitch);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.APP_OBJECT: {
				AppObject appObject = (AppObject)theEObject;
				T result = caseAppObject(appObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.RULE: {
				...
				if (result == null) result = caseAppObject(rule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.APP: {
			...
			case MdnPackage.CONDITION: {
				...
				if (result == null) result = caseAppObject(condition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.TRAFFIC: {
				...
				if (result == null) result = caseAppObject(traffic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.TIME: {
				...
				if (result == null) result = caseAppObject(time);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.PACKET_HEADER: {
				...
				if (result == null) result = caseAppObject(packetHeader);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.APP_MONITOR: {
				AppMonitor appMonitor = (AppMonitor)theEObject;
				T result = caseAppMonitor(appMonitor);
				if (result == null) result = caseApp(appMonitor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MdnPackage.FLOW: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>App Object</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>App Object</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAppObject(AppObject object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Open Flow Switch</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Open Flow Switch</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOpenFlowSwitch(OpenFlowSwitch object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>App Monitor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>App Monitor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAppMonitor(AppMonitor object) {
		return null;
	}
