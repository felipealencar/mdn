...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    #Function called when switch connects to the controller
    @set_ev_cls(dpset.EventDP, dpset.DPSET_EV_DISPATCHER)
    def handler_datapath(self, ev):
	#instances:
    #s1 - dp.id = 1 -> netflow enabled
	#s2 - dp.id = 2 -> netflow disabled
	...
	#TODO: self._define_flow_delegation(switch_list)
	#basially, it adds forwarding flow rules only in the shortest path to capable switch
